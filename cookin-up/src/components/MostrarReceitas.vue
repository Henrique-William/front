...
export default {
  ...
  async created() {
    ...
    this.receitasEncontradas = receitas.filter((receita) => {
      // Lógica que verifica se posso fazer a receita
      // Todos os ingredientes de uma receita deve estar incluso na minha lista de ingredientes
      // Se sim devemos retornar 'true' para o filter
